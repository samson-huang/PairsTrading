...
if __name__ == '__main__':
    ...
    for index_code in list_1:
        local_url = 'C://temp//upload//' + local_datetime + '_pattern_graph//' + local_datetime + '_' + code2secname[
            index_code] + '_detail.jpg'
        ...
        plot_patterns_chart(data1, patterns_record1, True, False, code2secname[index_code],
