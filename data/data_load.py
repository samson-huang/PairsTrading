...
def GetDataFromTushare(today, fpath):
        pro = ts.pro_api()
...
GetDataFromTushare('20230530', 'C:/Users/huangtuo/.qlib/qlib_data/cn_data')

/*
dump_update ==增量==更新数据
dump_all ==全量==覆盖数据
python c:/qlib-main/scripts/dump_bin.py dump_update --csv_path  C:/Users/huangtuo/.qlib/qlib_data/cn_data/day_csv --qlib_dir C:/Users/huangtuo/.qlib/qlib_data/cn_data --include_fields  open,close,high,low,volume,factor
