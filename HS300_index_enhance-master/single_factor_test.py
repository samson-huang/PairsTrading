...
def test_yearly(factors=None, start_year=2009, end_year=2011):
    ...
    #############################################
    ##############################################
    #reformed_test_result = {}
    #for outerKey, innerDict in test_result.items():
    #    for innerKey, values in innerDict.items():
    #        reformed_test_result[(outerKey,
    #                       innerKey)] = values
    #test_result=pd.DataFrame(reformed_test_result)
    ##############################################
    ###############################################
...
def panel_to_matrix(factors, factor_path=factor_path, save_path=sf_test_save_path):
    ...
    datpanel.to_excel(os.path.join(sf_test_save_path, 'datpanel.xlsx'),
                         encoding='gbk')
    ##############################################
