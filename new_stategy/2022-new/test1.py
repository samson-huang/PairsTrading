...
if __name__=='__main__':
    ...
    sched.add_job(job, 'cron',id=index_name+'_'+end, day_of_week='mon-fri', hour=18, minute=17,args=[index_name,start,end])
    sched.start()
